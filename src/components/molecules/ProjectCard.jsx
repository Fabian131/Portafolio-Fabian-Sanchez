      ...
      <div className="w-full h-48 sm:h-56 lg:h-64 rounded-2xl overflow-hidden relative group-hover:shadow-[0_0_30px_rgba(14,165,233,0.3)] transition-shadow duration-500">
        {hasVideo && isPlaying ? (
          ...
          <>
            ...
            >
              <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white/90 dark:bg-white/20 backdrop-blur flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg">
                <Play size={28} className="text-zinc-900 dark:text-white ml-1" fill="currentColor" />
              </div>
            </button>
            ...
            <h3 className="text-2xl sm:text-3xl font-semibold absolute bottom-4 left-4 right-4 drop-shadow-lg text-zinc-900 dark:text-white group-hover:text-cyan-600 dark:group-hover:text-cyan-300 group-hover:-translate-y-2 transition-all duration-300 pointer-events-none">{title}</h3>
          </>
        ) : (
          <>
            <div
            ...
            <h3 className="text-2xl sm:text-3xl font-semibold absolute bottom-4 left-4 right-4 drop-shadow-lg text-zinc-900 dark:text-white group-hover:text-cyan-600 dark:group-hover:text-cyan-300 group-hover:-translate-y-2 transition-all duration-300">{title}</h3>
          </>
        )}
      </div>
